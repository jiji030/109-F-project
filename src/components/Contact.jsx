  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div
        ...
        className="flex-[0.75] bg-tertiary p-8 rounded-2xl"  // Keep padding as is for the shape
      >
        <p className="sm:text-[18px] text-[14px] text-white uppercase tracking-wider">
          Get in touch
        </p>
        <h3 className="text-white font-black md:text-[60px] sm:text-[50px] xs:text-[40px] text-[20px]">
          Contact.
        </h3>
        ...
        <form
          ...
          className="mt-6 flex flex-col gap-6"  // Adjust gap for consistency
        >
          ...
          <button
            type="submit"
            className="bg-black-200 py-3 px-8 outline-none w-fit text-white font-bold shadow-md shadow-black-200 rounded-xl"
          >
